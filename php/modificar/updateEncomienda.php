...
$alto = $_POST['inputAlto'];

// $nombreRecibe = $_POST['inputName'];
// $apellidoMaternoRecibe = $_POST['inputApellidoPaterno'];
// $apellidoPaternoRecibe = $_POST['inputApellidoMaterno'];
// $rutRecibe = $_POST['inputRutDestinatario'];
...
$sql = "
    UPDATE public.encomienda
	SET peso=" . $peso . ", largo=" . $largo . ", ancho=" . $ancho . ", alto=" . $alto . "
