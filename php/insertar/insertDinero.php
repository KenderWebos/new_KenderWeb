...
$telefonoRecibe = $_POST['inputTelefonoDestinatario'];
...
if (getUserByRut($rutEnvia, $conexion)) {
    ...
    if ($rutRecibe != null and $rutEnvia != null) {
        ...
        echo "Cliente registrado exitosamente, envio de dinero aceptado";
    } else {
...
$sql = "
        INSERT INTO public.dinero(
        monto, remitente, numero_orden_transporte)
        VALUES (".$monto.", '".$nombreRecibe."',".$num_orden_transporte." );
            ";
