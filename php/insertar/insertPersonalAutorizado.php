...
$rutEnvia = $_POST['inputRutPersonaAutorizada'];
$rutEmpresa = $_POST['inputRutEmpresa'];
...
$sql = "
    INSERT INTO public.persona_autorizada(
	rut_persona_autorizada, rut_empresa, nombre, apellido_paterno, apellido_materno, correo, telefono, departamento, username, password)
	VALUES ('" . $rutEnvia . "', '" . $rutEmpresa . "', '" . $nombreEnvia . "', '" . $apellidoPaternoEnvia . "', '" . $apellidoMaternoEnvia . "', '" . $correoEnvia . "', '" . $telefonoEnvia . "', '" . $departamento . "', '" . $usuario . "', '" . $contraseña . "');
            ";

if ($rutEnvia != null and $rutEmpresa != null) {
    $insercion = pg_query($conexion, $sql);
} else {
    echo "INGRESE CORRECTAMENTE TODOS LOS DATOS DE USUARIO";
}
