...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <form class="form-inline" action="../../../php/modificarPedido.php" method="post">
        <input class="form-control mr-sm-2" name="index" type="search" placeholder="Buscar pedido y modificar" aria-label="Search">
        <button class="btn btn-outline-warning my-2 my-sm-0" type="submit">Buscar y modificar</button>
    </form>
</nav>
    ...
    if (pg_numrows($consultaSobre) > 0) {
        while ($obj = pg_fetch_object($consultaSobre)) {
            ...
            if ($num1 == $obj->numero_orden_transporte) {
                ...
                echo '
                <center style="width:40%">
                    <form style="background-color:gray" action="../php/updateSobre.php" method="post">
                    <h3>INGRESE LOS DATOS ACTUALIZADOS DE LA SOBRE</h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="exampleInputNombre">Remitente: </label>
                                <input type="text" class="form-control" name="inputRemitente" placeholder="Ingrese el remitente" value ="' . $obj->remitente . '">
                            </div>
    ...
    if (pg_numrows($consultaDinero) > 0) {
        ...
        while ($obj = pg_fetch_object($consultaDinero)) {
            ...
            if ($num1 == $obj->numero_orden_transporte) {
                ...
                echo '
            <center style="width:40%">
                <form style="background-color:gray" action="../php/updateDinero.php" method="post">
                <h3>INGRESE LOS DATOS ACTUALIZADOS DEL DINERO</h3>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="inputMonto" placeholder="Ingrese el peso del paquete" value ="' . $obj->monto . '">
                        </div>
    ...
    if (pg_numrows($consultaEnvio) > 0) {
        while ($obj = pg_fetch_object($consultaEnvio)) {
            ...
            if ($num1 == $obj->numero_orden_transporte) {
                ...
                echo '
            <center style="width:40%">
                <form style="background-color:gray" action="../php/updateEnvio.php" method="post">
                <h3>INGRESE LOS DATOS ACTUALIZADOS DE LA ENCOMIENDA</h3>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inputId" placeholder="Este es el numero de orden de pedido" value ="' . $obj->numero_orden_transporte . '">
                        ...
                        <div class="form-group">
                        <label for="exampleInputNombre">Region: </label>
                        <input type="text" class="form-control" name="inputRegion" placeholder="Ingrese su Region" value ="' . $obj->region . '">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputNombre">Comuna: </label>
                            <input type="text" class="form-control" name="inputComuna" placeholder="Ingrese su comuna" value ="' . $obj->comuna . '">
                        </div>
        
                        <div class="form-group">
                            <label for="exampleInputNombre">Calle: </label>
                            <input type="text" class="form-control" name="inputCalle" placeholder="Ingrese su calle" value ="' . $obj->calle . '">
                        </div>
                    
                        <div class="form-group">
                            <label for="exampleInputNombre">Numero: </label>
                            <input type="text" class="form-control" name="inputNumero" placeholder="Ingrese su numero de casa" value ="' . $obj->numero . '">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="inputEstado">
                                ...
                                <option value="Saliendo de sucursal">Saliendo de sucursal</option>
